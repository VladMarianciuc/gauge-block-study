...
![Fig.9 Schema structurii simetrice a intervalului studiat.](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2009.jpg){.lightbox}
...
![Fig.10 Descriere schematică a intuiției ajustate.](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2010.jpg){.lightbox}
...
![Fig.11 Evoluția intuiție pe parcursul realizării acestei lucrări.](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2011.jpg){.lightbox}
...
[^8]: Francis, W. (2017, Noiembrie 22). *Origins of precision.* Machine Thinking, min. 29:55<br>
    <https://youtu.be/gNRnrn5DE58?si=bz9xrtXgltSV4QQR&t=1795>

# 3. Optimizare și algoritm
...
![Fig.12 Când construim o măsura X, rămâne măsura Total – X](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2012.png){.lightbox}
...
![Fig.13 Vizualizare schematică a modului de căutare a combinației optime.](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2013.jpg){#fig13 .lightbox}
...
[^9]: Wikimedia Foundation. (2024a, May 13). *Knapsack problem*. Wikipedia.
    <https://en.wikipedia.org/wiki/Knapsack_problem>

[^10]: Wikimedia Foundation. (2024, June 9). *Subset sum problem.* Wikipedia.
    <https://en.wikipedia.org/wiki/Subset_sum_problem>

[^11]: Garg, A. (2022, June 23). *Printing items in 0/1 Knapsack*. GeeksforGeeks.
...
![Fig.14 QR-code către Notebook-ul Colab care conține codul prezentat mai sus, poate fi rulat direct din browser.](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2014.png){.lightbox}
...
![Fig.15 QR-code către aplicația interactivă construită folosind rezultatele acestei lucrări, poate fi deschisă direct în browser.](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2015.png){.lightbox}

<br>

![Fig.16 Distributia combinatiilor, in functie de marimea pe care vrem sa o construim.](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2016.png){.lightbox}

<br>

![Fig. 17 Evidențierea naturii liniare pe intervale a acestei distribuții.](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2017.jpg){.lightbox}
...
[^12]: Wikimedia Foundation. (2024b, June 1). *Metrology*. Wikipedia.
...
[^13]: Muelaner, J. (2017a, November 1). *Key principles in metrology and Measurement Systems Analysis (MSA).*
    <https://www.muelaner.com/metrology/#uncertainty>

![Fig.18 Ce mărime are creionul?](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2018.png){.lightbox}
...
Lungimea unei cale plan paralelă este definită în relație cu următoarele condiții de
referință standard:[^14]

[^14]: Doiron, T. and Beers, J. (1995), *The Gage Block Handbook*, Monograph (NIST MN), National Institute of
    Standards and Technology, Gaithersburg, MD, \[online\], p.10
...
[^15]: Wikimedia Foundation. *Gauge block.* Wikipedia.
    [http://www.starrett-webber.com/gb46.htm](https://en.wikipedia.org/wiki/Gauge_block)

[^16]: Webber, S. (2003, November 21). *Wringing Gage Blocks*. Starret-Webber.
    <http://www.starrett-webber.com/gb46.html>

![Fig.19a Valoarea nominală a unei cale plan paralele include stratul de calare.](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2019a.png){.lightbox}
...
[^17]: Doiron, T. and Beers, J. (1995), *The Gage Block Handbook*, Monograph (NIST MN), National Institute of
    Standards and Technology, Gaithersburg, MD, \[online\], p.13
    <https://tsapps.nist.gov/publication/get_pdf.cfm?pub_id=820735>
...
![Fig.19 Grade de toleranță pentru cale sistem imperial (exprimat in µin = 10-6 in).[^18]](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2019.png){.lightbox alt="Fig.19a Valoarea nominală a unei cale plan paralele include stratul de calare."}
...
![Fig.20 Populația unei distribuții normale în funcție de abaterea standard](https://raw.githubusercontent.com/VladMarianciuc/gauge-block-study/main/img/Fig%20-%2020.png){.lightbox}
...
[^20]: Wikimedia Foundation. (2023, August 12). *Sum of normally distributed random variables*. Wikipedia.
...
1.  Moore, W. R. (1970). *Foundations of mechanical accuracy* (1st ed., 3rd Print).
    <https://pearlhifi.com/06_Lit_Archive/15_Mfrs_Publications/Moore_Tools/Foundations_of_Mechanical_Accuracy.pdf>

2.  Francis, W. (2017, Noiembrie 22). *Origins of precision*. Machine Thinking.
    <https://www.youtube.com/watch?v=gNRnrn5DE58>
    (ref. 1, 8)

3.  Doiron, T. and Beers, J. (1995), *The Gage Block Handbook*, Monograph (NIST MN),
    National Institute of Standards and Technology, Gaithersburg, MD, \[online\].
    <https://tsapps.nist.gov/publication/get_pdf.cfm?pub_id=820735>
    (ref. 2, 6, 14)

4.  Webber, S. (2003, November 21). *Wringing Gage Blocks.* Starret-Webber.
    <http://www.starrett-webber.com/gb46.html>
    (ref. 3, 16, 17, 18)

5.  Muelaner, J. (2017a, November 1). *Key principles in metrology and Measurement Systems Analysis* <https://www.muelaner.com/metrology/>
    (ref. 4, 13)

6.  A&E Television Networks. (n.d.). *Interchangeable parts*. History.com.
    <https://www.history.com/topics/inventions/interchangeable-parts>
    (ref. 5)

7.  *The history of gauge blocks.* (n.d.)
    [https://www.mitutoyo.com/webfoo/wp-content/uploads/E12016-History-of-The-Gage-Block.pdf
    ](https://www.mitutoyo.com/webfoo/wp-content/uploads/E12016-History-of-The-Gage-Block.pdf)(ref. 7)

8.  Wikimedia Foundation. (n.d.). Wikipedia. <https://en.wikipedia.org/>
    (ref. 9, 10, 12, 15, 19)

9.  Garg, A. (2022, June 23). *Printing items in 0/1 Knapsack*. GeeksforGeeks.
    <https://www.geeksforgeeks.org/printing-items-01-knapsack/>
    (ref. 11)
...
1.  Fig.1 Foaia de prezentare al unui set cu 81 de cale plan paralele din 1944.
    Francis, W. (2017, Noiembrie 22). *Origins of precision*. Machine Thinking, min. 16:58
    <https://www.youtube.com/watch?v=gNRnrn5DE58>

2.  Fig.2 Afirmațiile de la care a pornit lucrarea (zoom Fig.1, ibidem)

3.  Fig.3 Cale plan paralele (sistem metric)
    Stenström, E. (2021, Martie 23). *Gauge blocks – the foundation to all modern industrial
    production.* Elastocon. <https://www.elastocon.com/learn-more/about-calibration/gauge-blocksthe-foundation-to-all-modern-industrial-production>

4.  Fig.4 Procedeul de calare a 2 cale (ibidem referința 3)

5.  Fig.5 Mai multe cale sunt calate pentru a obține o dimensiune. Se observă cum ele rămân lipite
    sub acțiunea gravitației. Clarence Leon Goodrich & Frank Arthur Stanley (1907) *Accurate Tool
    Work,* McGraw-Hill, New York, p.185, fig.196

6.  Fig.6 Setul de 81 de piese realizat de C.E. Johansson pentru fabricile Ford pe care Ford însuși l-a
    făcut cadou bunului său prieten, Thomas Edison. Acum acest set se află la Muzeul Preciziei din
    Windsor, Vermont, Statele Unite ale Americii.
    <https://americanprecision.org/wp-content/uploads/2020/06/IMG_1696.jpeg>

7.  Descriere schematică a intuiției. Imagine proprie.

8.  Fig.8 Toate măsurătorile au un grad de incertitudine iar cu cât marjele alese sunt mai mari, cu
    atât crește încrederea. Muelaner, J. (2017, November 1). *Key principles in metrology and
    Measurement Systems Analysis (MSA)*. <https://www.muelaner.com/metrology/#uncertainty>

9.  Fig.8a C.E. Johansson ținând în mână un „baton” de cale
    <https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjdc0vJRCaT_eIscJyFuiR6VYli7lShAZo8bx5EJSdqqUxnSGiFXAoEanO3fPC1ab2_HbqPcgzSwyz6JXDqcQ4uBoTNg3ZTUSjywV8MsCmMOS3JOkimLh_vveardZHtOu78BtkzfUp6-I/s1600/CE+Johansson.jpg>

10. Fig.9 Schema structurii simetrice a intervalului studiat. Imagine proprie.

11. Fig.10 Descriere schematică a intuiției ajustate. Imagine proprie.

12. Fig.11 Evoluția intuiție pe parcursul realizării acestei lucrări. Imagine proprie.

13. Fig.12 Când construim o măsura X, rămâne măsura Total – X. Imagine proprie

14. Fig.13 Vizualizare schematică a modului de căutare a combinației optime. Imagine proprie.

15. Fig.14 QR-code către Notebook-ul Colab cu algoritmul din cap. 3).

16. Fig.15 QR-code către aplicația interactivă Shinylive, poate fi deschisă direct în browser

17. Fig.16 Distributia combinațiilor, în functie de mărimea pe care vrem sa o construim. Img. proprie.

18. Fig. 17 Evidențierea naturii liniare pe intervale a acestei distribuții. Imagine proprie.

19. Fig.18 Ce mărime are creionul?
    <https://media.baamboozle.com/uploads/images/47624/1588733513_88858>

20. Fig.19a Valoarea nominală a unei cale plan paralele include stratul de calare. (Ibidem (ref. 16))

21. Fig.19 Grade de toleranță pentru cale sistem imperial (exprimat in µin = 10-6 in). (ref. 18)

22. Fig.20 Populația unei distribuții normale în funcție de abaterea standard
